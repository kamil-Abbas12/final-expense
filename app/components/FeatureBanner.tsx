      ...
      <div className="mx-auto max-w-7xl px-5">
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {features.map(({ label, icon: Icon }) => (
            ...
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-400 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-900 transition-colors">
